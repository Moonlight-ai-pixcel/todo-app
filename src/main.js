...
function addTask() { const title = window.prompt('タスク名を入力してください'); if (!title?.trim()) return; tasks.unshift({ id: Date.now(), title: title.trim(), category: 'Work', due: '今日', priority: 'medium', done: false }); save(); render() }
