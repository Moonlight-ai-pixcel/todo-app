...
app.addEventListener('click', (event) => {
  ...
  const action = event.target.closest('[data-action]')?.dataset.action; if (action === 'new') addTask(); if (action === 'settings') openSettings(); if (action === 'search') { document.querySelector('.search-row').classList.add('visible'); document.querySelector('#search-input')?.focus() }; if (action === 'clear-search') { searchQuery = ''; render() }
